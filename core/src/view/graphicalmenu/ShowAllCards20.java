...
public class ShowAllCards20 implements Screen {
    ...
    public ShowAllCards20(MyGdxGame game, boolean isMute, User currentLoggedInUser, String backAddress) {
    ...
    public void render(float delta) {
        ...
        text.draw(batch, "show all cards 20 - Spells and Traps", 500, 900);
