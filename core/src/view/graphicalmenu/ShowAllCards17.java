...
public class ShowAllCards17 implements Screen {
    ...
    public ShowAllCards17(MyGdxGame game, boolean isMute, User currentLoggedInUser, String backAddress) {
    ...
    public void render(float delta) {
        ...
        text.draw(batch, "show all cards 17 - Spells and Traps", 500, 900);
