...
public class ShowAllCards22 implements Screen {
    SpriteBatch batch;
    ...
    Texture next;
    Texture pre;
    Texture spellAbsorption;
    Texture supplySquad;
    Texture swordOfDarkDestruction;
    User currentLoggedInUser;
    String backAddress;

    public ShowAllCards22(MyGdxGame game, boolean isMute, User currentLoggedInUser, String backAddress) {
        ...
        spellAbsorption = new Texture("Cards/SpellTrap/SpellAbsorption.jpg");
        supplySquad = new Texture("Cards/SpellTrap/SupplySquad.jpg");
        swordOfDarkDestruction = new Texture("Cards/SpellTrap/SwordOfDarkDestruction.jpg");
    }
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (Gdx.input.getY() > 930 - pre.getHeight() && Gdx.input.getY() < 930) {
                if (Gdx.input.getX() > 700 && Gdx.input.getX() < 700 + pre.getWidth()) {
                    game.setScreen(new ShowAllCards21(game, isMute, currentLoggedInUser, backAddress));
                    dispose();
                }
            }
