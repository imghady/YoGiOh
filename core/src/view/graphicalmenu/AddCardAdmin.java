...
public class AddCardAdmin implements Screen, Input.TextInputListener {
    ...
    public AddCardAdmin(Mola game, boolean isMute, User currentLoggedInUser) {
    ...
    public void render(float delta) {
        ...
        text.draw(batch, "Admin Add Card", 150, 850);
